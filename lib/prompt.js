...
export const FORMATS = {
  ...
  image: {
    label: 'Image post',
    brief:
      'A single-image post: one designed picture plus the caption that goes ' +
      'under it. The picture is actually drawn from what you write in "image", ' +
      'so put at most 6 words of headline on it and say plainly what it shows. ' +
      'Everything that needs explaining belongs in the caption instead.'
  }
};
