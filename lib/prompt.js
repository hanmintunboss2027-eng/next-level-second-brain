...
export function buildSystemPrompt(brand, context, format) {
  ...
  return [
    ...
    context || '(The vault is empty. Say so plainly and answer from nothing else.)',
    '',
    '=== AFTER THE CONTENT ===',
    'End your reply with a line starting "Sources: " listing the note paths you',
    'actually used. If you used none, say "Sources: none — the vault had nothing',
    'on this."'
  ].join('\n');
}
